...
export const caruselFourCardDisplay = (counter:string,id: string, arr: Prouduct[],title:string="מוצרים חדשים",dir:string="ltr"): void => {
  let display1: number = 0;
  let display2: number = 1;
  let display3: number = 2;
  let display4: number = 3;

  const display = (id: string, arr: Prouduct[]): void => {
