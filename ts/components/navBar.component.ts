...
export const displayNavBar=(id:string):void=>{
    ...
    // input assigns
    let searchInp=document.getElementById("searchInp") as HTMLInputElement;
    ...
    const searchForProducts=()=>{
      if(searchInp && searchInp.value && searchDisplay){
        ...
        if(json){
          let productArr=JSON.parse(json)as Prouduct[];
