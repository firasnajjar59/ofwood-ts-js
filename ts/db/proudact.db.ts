...
export let productArr: Prouduct[];
if (localStorage.getItem("productArr")) {
  productArr = JSON.parse(
    localStorage.getItem("productArr") as string
  ) as Prouduct[];
} else {
  productArr = [
    new Prouduct(
      ...
      {
        description:
          "יחידות אחסון אלה הם אפשרויות נחמדות לסידור ספרי ילדים, שכן לפריטים הללו יש בדרך כלל כמה מדפים שעוזרים בארגון. הגלגלים מאפשרים לקחת את הספרים לחדרים שונים בלי הרבה עבודה ומאמץ (וגם מקלים על ניקיון הבית).",
        width: "140",
        hight: "12",
        length: "ssas",
        notes: "sdf",
    ...
    new Prouduct(
      ...
      "פתרונות אחסון",
      ["red", "blue", "green"],
      ["./assets/imgs/bookshelvess%20photo/il_794xN.1952623782_6wgy.webp"],
      "popular"
    ),
    new Prouduct(
      "table",
    ...
    new Prouduct(
      ...
      "אחסון",
      ["red", "blue", "green"],
      ["./assets/imgs/bookshelvess%20photo/1.png"],
      "upcomming"
    ),
    new Prouduct(
      "2יחידת אחסון ספרים",
